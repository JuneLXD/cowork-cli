...
`history/rooms/` holds exported room logs from two earlier projects that used cowork
...
kept verbatim. Do not edit them; `cowork read --room <name>` cannot open them (they are not
